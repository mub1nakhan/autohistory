...
class VehicleViewSet(ModelViewSet):
    queryset = (
        Vehicle.objects.select_related("risk_score", "owner", "registered_by")
    ...
    ordering_fields = ["created_at", "year", "mileage", "risk_score__risk_score"]
    ordering = ["-created_at"]
    ...
    @extend_schema(
        ...
        request=VehicleOwnershipTransferSerializer,
    )
    ...
    @extend_schema(tags=["vehicles"], summary="Get vehicle summary statistics")
    @action(detail=True, methods=["get"], url_path="summary")
    def summary(self, request, pk=None):
        vehicle = self.get_object()
        summary = VehicleService.get_vehicle_summary(vehicle)
