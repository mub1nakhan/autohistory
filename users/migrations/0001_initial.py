# Generated by Django 5.1 on 2026-05-30 06:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "-logged_in_at"], name="login_histo_user_id_aaef2d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="loginhistory",
            index=models.Index(
                fields=["refresh_token_jti"], name="login_histo_refresh_f33118_idx"
            ),
        ),
    ]
